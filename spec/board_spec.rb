...
RSpec.describe Board do
  ...
  describe '#render' do
    it 'renders a single ship passed as an argument by its location' do
      expect(subject.render test_ship_one).to eq test_board_one
    end

    it 'renders a different ship passed as an argument by its location' do
      expect(subject.render test_ship_two).to eq test_board_two
    end

    it 'renders another separate ship passed as an argument by its location' do
